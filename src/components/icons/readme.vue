<template>
  ...
  >
    ...
    />
    <path
      d="m17.25 10.5c-3.722 0-6.75 3.028-6.75 6.75s3.028 6.75 6.75 6.75 6.75-3.028 6.75-6.75-3.028-6.75-6.75-6.75zm1 9.5c0 .552-.447 1-1 1s-1-.448-1-1v-3.5c0-.552.447-1 1-1s1 .448 1 1zm-1-5c-.552 0-1-.448-1-1s.448-1 1-1 1 .448 1 1-.448 1-1 1z"
    />
  </svg>
</template>
